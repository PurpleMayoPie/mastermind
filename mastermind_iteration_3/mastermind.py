...
def take_turn(code):
    ...
    values = (correct_digits_and_position, correct_digits_only)
...
def check_correctness(turns, values):
    """Checks correctness of answer and show output to user"""
    correct_digits_and_position, correct_digits_only = values
    correct = False
...
def run_game():
    ...
    while not correct and turns < 12:
        #take_turn(code)
        turns += 1
        correct = check_correctness(turns, take_turn(code))
